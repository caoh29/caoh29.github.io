...
export const skillCategories = [
  {
    ...
    skills: [
      ...
      { name: "PHP", level: 50, category: "Programming Languages" },
      { name: "Golang", level: 30, category: "Programming Languages" },
      { name: "C++", level: 30, category: "Programming Languages" },
      { name: "Bash", level: 60, category: "Programming Languages" },
    ],
  },
  {
    name: "Backend Frameworks and ORM",
    icon: "Server",
    skills: [
      { name: "Node.js", level: 90, category: "Backend" },
      { name: "NestJS", level: 75, category: "Backend" },
      { name: "Express.js", level: 80, category: "Backend" },
      { name: "Fastify", level: 60, category: "Backend" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "AWS Route 53", level: 60, category: "Cloud" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Formik", level: 70, category: "Frontend" },
      { name: "Styled Components", level: 60, category: "Frontend" },
      { name: "Framer Motion", level: 50, category: "Frontend" },
    ],
  },
  {
    name: "Other",
    ...
    skills: [
      ...
      { name: "React Testing Library", level: 80, category: "Other" },
      ...
      { name: "Figma", level: 50, category: "Other" },
      { name: "Jira", level: 50, category: "Other" },
      { name: "Arduino", level: 50, category: "Other" },
      { name: "RaspberryPi", level: 40, category: "Other" },
